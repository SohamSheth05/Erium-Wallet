...
class TransactionDataProviderManagerTest {
    ...
    fun baseProvider() {
        assertThat(
            dataProviderManager.baseProvider(btc),
            instanceOf(BitcoinForksProvider::class.java)
        )
        assertThat(
            dataProviderManager.baseProvider(bch),
            instanceOf(BitcoinForksProvider::class.java)
        )
        assertThat(
            dataProviderManager.baseProvider(eth),
            instanceOf(EthereumForksProvider::class.java)
        )
    }
