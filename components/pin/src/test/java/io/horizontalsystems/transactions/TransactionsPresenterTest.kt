...
class TransactionsPresenterTest {
    ...
    fun fetchRecords() {
        val fetchDataList =
            listOf<TransactionsModule.FetchData>(mock(TransactionsModule.FetchData::class.java))
    ...
    fun onUpdateLastBlockHeight_threshold() {
        ...
        whenever(loader.itemIndexesForPending(wallet1, oldBlockInfo.height - threshold)).thenReturn(
            listOf(1)
        )
