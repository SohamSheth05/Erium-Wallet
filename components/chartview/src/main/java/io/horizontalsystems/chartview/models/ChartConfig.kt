...
class ChartConfig(private val context: Context, attrs: AttributeSet?) {
    ...
    var trendUpGradient =
        GradientColor(Color.parseColor("#00416BFF"), Color.parseColor("#0013D670"))
    var trendDownGradient =
        GradientColor(Color.parseColor("#007413D6"), Color.parseColor("#00FF0303"))
