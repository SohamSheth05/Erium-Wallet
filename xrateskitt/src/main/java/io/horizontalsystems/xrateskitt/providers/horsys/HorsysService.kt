...
interface HorsysService {
    ...
    fun coinDefiTvl(
        @Path("coinGeckoId") timePeriod: String,
        @Query("currency_code") currencyCode: String
    ): Single<Response.DefiTvl>
