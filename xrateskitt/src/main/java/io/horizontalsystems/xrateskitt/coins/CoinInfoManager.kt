...
import io.horizontalsystems.xrateskit2.entities.CoinFundCategory
import io.horizontalsystems.xrateskit2.entities.ExchangeInfoEntity
...
class CoinInfoManager(
    ...
    fun getLinks(
        coinType: CoinType,
        linksByProvider: Map<LinkType, String>
    ): Map<LinkType, String> {
