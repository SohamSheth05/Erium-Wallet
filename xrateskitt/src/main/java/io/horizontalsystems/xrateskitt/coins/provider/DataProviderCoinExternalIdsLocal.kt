...
class DataProviderCoinExternalIdsLocal(private val context: Context) :
    ...
    override fun getDataNewerThan(resourceInfo: ResourceInfo?): Data<ProviderCoinsResource>? {
        ...
        return Data(
            "ProviderCoinsResourceLocal",
            ProviderCoinsResource.parseFile(false, context.assets.open(providerCoinsFileName))
        )
    }
}
