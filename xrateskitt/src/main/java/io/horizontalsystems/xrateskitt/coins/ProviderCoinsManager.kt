...
import io.horizontalsystems.xrateskit2.coins.provider.CoinExternalIdsSyncer
...
class ProviderCoinsManager(
    ...
    fun updatePriorities() {
        val coinsPriorityUpdateTimestamp =
            storage.getResourceInfo(ResourceType.PROVIDER_COINS_PRIORITY)?.updatedAt ?: 0
