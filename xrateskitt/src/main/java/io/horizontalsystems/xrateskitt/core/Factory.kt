...
class Factory(private val expirationInterval: String) {
    fun createHistoricalRate(
        coinType: CoinType,
        currency: String,
        value: BigDecimal,
        timestamp: Long
    ...
    fun createCoinMarket(
        ...
        volume: BigDecimal,
        supply: BigDecimal,
        rateDiffPeriod: BigDecimal?,
        marketCap: BigDecimal? = null,
        dilutedMarketCap: BigDecimal? = null,
        totalSupply: BigDecimal? = null,
        athChangePercentage: BigDecimal? = null,
        atlChangePercentage: BigDecimal? = null
    ): CoinMarket {
