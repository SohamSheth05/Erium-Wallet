...
class PicassoRoundedImageView(context: Context, attributeSet: AttributeSet?) :
    ...
    init {
        val attributes =
            context.obtainStyledAttributes(attributeSet, R.styleable.PicassoRoundedImageView)
        try {
