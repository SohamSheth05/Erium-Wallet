...
class BitcoinCashAdapter(
...
) : BitcoinBaseAdapter(kit, syncMode = syncMode, backgroundManager = backgroundManager),
    ...
    companion object {
        ...
        private fun createKit(
            ...
            val accountType =
                (account.type as? AccountType.Mnemonic) ?: throw UnsupportedAccountException()
            val bchCoinType = wallet.configuredCoin.settings.bitcoinCashCoinType
