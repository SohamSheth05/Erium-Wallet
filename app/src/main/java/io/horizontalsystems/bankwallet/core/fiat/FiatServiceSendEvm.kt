...
class FiatServiceSendEvm(
    ...
    private fun sync() {
        ...
        if (coin != null) {
            ...
            val currencyAmountInfo = currencyAmount?.let {
            ...
            secondaryAmountInfo =
                SendModule.AmountInfo.CurrencyValueInfo(CurrencyValue(currency, BigDecimal.ZERO))
        }
    ...
    private fun syncCoinAmount() {
        ...
        _coinAmount =
            if (coin != null && currencyAmount != null && rate != null && rate > BigDecimal.ZERO) {
