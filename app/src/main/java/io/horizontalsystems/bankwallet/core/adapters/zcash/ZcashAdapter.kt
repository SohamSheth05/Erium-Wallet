...
class ZcashAdapter(
    ...
    private val lightWalletDHost =
        if (testMode) "lightwalletd.testnet.electriccoin.co" else "zcash.horizontalsystems.xyz"
    ...
    init {
        ...
        synchronizer.processorInfo.distinctUntilChanged()
            .collectWith(GlobalScope, ::onProcessorInfo)
    ...
    override val balanceLocked: BigDecimal?
        get() {
            ...
            val lockedBalance =
                (latestBalance.totalZatoshi - latestBalance.availableZatoshi).coerceAtLeast(0)
    ...
    override val transactionRecordsFlowable: Flowable<List<TransactionRecord>>
        get() = transactionsProvider.newTransactionsFlowable.map { transactions ->
            transactions.mapNotNull {
    ...
    override val availableBalance: BigDecimal
        get() = (synchronizer.latestBalance.availableZatoshi - defaultFee()).coerceAtLeast(0)
            .convertZatoshiToZec()
