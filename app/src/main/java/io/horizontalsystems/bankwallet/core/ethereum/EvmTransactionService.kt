...
class EvmTransactionService(
    ...
    private fun getTransactionAsync(
        gasPrice: BigInteger,
                ...
                getGasLimitAsync(gasPrice, adjustedTransactionData)
                    .map { estimatedGasLimit ->
                        ...
                        Transaction(
                            ...
                            GasData(estimatedGasLimit, gasLimit, gasPrice.toLong())
                        )
                    }
            }
    }
    ...
    private fun getAdjustedTransactionDataAsync(
        ...
        if (transactionData.input.isEmpty() && transactionData.value == evmBalance) {
            val stubTransactionData =
                TransactionData(transactionData.to, BigInteger.ONE, byteArrayOf())
