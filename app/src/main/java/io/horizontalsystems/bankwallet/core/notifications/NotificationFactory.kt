    ...
    private fun getBodyText(
        ...
        return when (type) {
            NotificationType.Trend -> {
                ...
                val stringRes =
                    if (isDown) R.string.Notification_TrendDown else R.string.Notification_TrendUp
            ...
            NotificationType.Change -> {
                ...
                val stringRes =
                    if (isUp) R.string.Notification_PriceUp else R.string.Notification_PriceDown
