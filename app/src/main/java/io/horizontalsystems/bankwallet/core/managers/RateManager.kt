...
import io.horizontalsystems.xrateskit2.XRatesKit
...
class RateManager(
    ...
    override fun coinMarketDetailsAsync(
        ...
        return kit.getCoinMarketDetailsAsync(
            coinType,
            currencyCode,
            rateDiffCoinCodes,
            rateDiffPeriods
    ...
    override fun getTopMarketList(
        ...
        return kit.getTopCoinMarketsAsync(
            currency,
            itemsCount = itemsCount,
            fetchDiffPeriod = diffPeriod
        )
    }
