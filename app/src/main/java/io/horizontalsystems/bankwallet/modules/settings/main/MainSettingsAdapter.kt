...
class MainSettingsAdapter(private val activity : Activity, private val items: List<SettingsViewItem?>) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return when (viewType) {
            viewTypeSpace -> SettingsViewHolderSpace(
                inflate(
                    parent,
                    R.layout.view_settings_item_space
                )
            )
            viewTypeBottom -> SettingsViewHolderBottom(
                inflate(
                    parent,
                    R.layout.view_settings_item_bottom
                )
            )
            viewTypeSwitch -> SettingsViewHolderSwitch(
                inflate(
                    parent,
                    R.layout.view_holder_setting_item_with_switch
                )
            )
    ...
    class SettingsViewHolderSpace(override val containerView: View) :
        RecyclerView.ViewHolder(containerView), LayoutContainer

    class SettingsViewHolderBottom(override val containerView: View) :
        RecyclerView.ViewHolder(containerView), LayoutContainer {
        ...
        fun bind(context : Activity, item: SettingsMenuBottom) {
            ...
            if (App.localStorage.currentTheme == ThemeType.Dark) {
                companyLogo.setBackgroundResource(R.drawable.dark_logo)
            } else {
                companyLogo.setBackgroundResource(R.drawable.white_logo)
            }
    ...
    class SettingsViewHolderSwitch(override val containerView: View) :
        RecyclerView.ViewHolder(containerView), LayoutContainer {

        private val switchSettingView =
            containerView.findViewById<SettingsViewSwitch>(R.id.switchSettingView)
    ...
    class SettingsViewHolderArrow(override val containerView: View) :
        RecyclerView.ViewHolder(containerView), LayoutContainer {
