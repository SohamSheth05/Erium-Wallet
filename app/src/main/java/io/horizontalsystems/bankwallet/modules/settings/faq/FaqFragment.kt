...
class FaqListAdapter(private val listener: Listener) :
    ListAdapter<FaqItem, ViewHolderFaq>(faqDiff) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolderFaq {
        return ViewHolderFaq(
            LayoutInflater.from(parent.context)
                .inflate(R.layout.view_holder_faq_item, parent, false), listener
        )
    }
...
class ViewHolderFaq(override val containerView: View, listener: FaqListAdapter.Listener) :
