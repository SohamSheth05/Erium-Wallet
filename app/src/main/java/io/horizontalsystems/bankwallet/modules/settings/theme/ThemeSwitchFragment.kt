...
class ThemeSwitchAdapter(private val onItemClick: (ThemeViewItem) -> Unit) :
    ...
    class ViewHolder(override val containerView: View, onItemClick: (ThemeViewItem) -> Unit) :
        ...
        companion object {
            fun create(parent: ViewGroup, onItemClick: (ThemeViewItem) -> Unit) =
                ViewHolder(inflate(parent, R.layout.view_holder_theme_switch_item), onItemClick)
        }
    }

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int) =
        ViewHolder.create(parent, onItemClick)
