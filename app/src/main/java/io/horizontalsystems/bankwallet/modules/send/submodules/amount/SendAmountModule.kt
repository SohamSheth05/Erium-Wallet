...
object SendAmountModule {
    ...
    open class ValidationError : Exception() {
        ...
        class NotEnoughForMinimumRequiredBalance(val minimumRequiredBalance: CoinValue) :
            ValidationError()
    ...
    class Factory(
        ...
        override fun <T : ViewModel> create(modelClass: Class<T>): T {
            ...
            val interactor = SendAmountInteractor(
                baseCurrency,
                App.xRateManager,
                App.localStorage,
                wallet.coin,
            ...
            val sendAmountPresenterHelper =
                SendAmountPresenterHelper(
                    App.numberFormatter, wallet.coin, baseCurrency, coinDecimal,
                    currencyDecimal
                )
            val presenter = SendAmountPresenter(
                view,
                interactor,
                sendAmountPresenterHelper,
                wallet.coin,
