...
class MarketMetricsAdapter(
    ...
    override fun onBindViewHolder(
        holder: MarketMetricsViewHolder,
        position: Int,
    ...
    companion object {
        private val diff = object : DiffUtil.ItemCallback<MarketMetricsWrapper>() {
            override fun areItemsTheSame(
                oldItem: MarketMetricsWrapper,
                newItem: MarketMetricsWrapper
            ): Boolean = true
...
data class MarketMetricsWrapper(
    val marketMetrics: MarketMetrics?,
    val loading: Boolean,
    val showSyncError: Boolean
)

class MarketMetricsViewHolder(override val containerView: View) :
