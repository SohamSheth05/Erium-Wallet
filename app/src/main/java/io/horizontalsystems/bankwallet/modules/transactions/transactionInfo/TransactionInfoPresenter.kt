...
class TransactionInfoPresenter(
    ...
    private fun getExplorerData(hash: String, testMode: Boolean, coinType: CoinType): TransactionInfoModule.ExplorerData {
        return when (coinType) {
            ...
            CoinType.BinanceSmartChain, is CoinType.Bep20, is CoinType.Dgc, is CoinType.Dsc, is CoinType.Dpc -> TransactionInfoModule.ExplorerData("bscscan.com", if (testMode) null else "https://bscscan.com/tx/$hash")
