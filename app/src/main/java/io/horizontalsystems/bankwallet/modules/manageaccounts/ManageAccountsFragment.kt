...
class AccountViewHolder(override val containerView: View, val listener: Listener) :
        ...
        fun create(parent: ViewGroup, listener: Listener): AccountViewHolder {
            return AccountViewHolder(
                LayoutInflater.from(parent.context)
                    .inflate(R.layout.view_holder_manage_account_item, parent, false), listener
            )
        }
    }
}
...
class MarginViewHolder(override val containerView: View) : RecyclerView.ViewHolder(containerView),
    LayoutContainer {
    companion object {
        fun create(parent: ViewGroup): MarginViewHolder {
            return MarginViewHolder(
                LayoutInflater.from(parent.context)
                    .inflate(R.layout.view_settings_item_space, parent, false)
            )
        }
    }
}
...
class ActionViewHolder(override val containerView: View) : RecyclerView.ViewHolder(containerView),
    LayoutContainer {
    ...
    companion object {
        fun create(parent: ViewGroup): ActionViewHolder {
            return ActionViewHolder(
                LayoutInflater.from(parent.context)
                    .inflate(R.layout.view_holder_manage_account_action, parent, false)
            )
        }
    }
}
...
class ManageAccountHintViewHolder(override val containerView: View) :
    RecyclerView.ViewHolder(containerView), LayoutContainer {
    companion object {
        fun create(parent: ViewGroup): ManageAccountHintViewHolder {
            return ManageAccountHintViewHolder(
                LayoutInflater.from(parent.context)
                    .inflate(R.layout.view_holder_manage_accounts_hint, parent, false)
            )
        }
    }
}
