...
class PrivacySettingsViewModel : ViewModel(), PrivacySettingsModule.IPrivacySettingsView,
    PrivacySettingsModule.IPrivacySettingsRouter {
    ...
    val showTransactionsSortingSelectorDialog =
        SingleLiveEvent<Pair<List<TransactionDataSortingType>, TransactionDataSortingType>>()
    val showCommunicationSelectorDialog =
        SingleLiveEvent<Triple<List<CommunicationMode>, CommunicationMode, Coin>>()
    ...
    override fun showTransactionsSortingOptions(
        items: List<TransactionDataSortingType>,
        selectedItem: TransactionDataSortingType
    ) {
    ...
    override fun showCommunicationSelectorDialog(
        communicationModeOptions: List<CommunicationMode>,
    ...
    override fun showSyncModeSelectorDialog(
        syncModeOptions: List<SyncMode>,
        selected: SyncMode,
        coin: Coin
    ) {
    ...
    override fun showCommunicationModeChangeAlert(
        coin: Coin,
        selectedCommunication: CommunicationMode
    ) {
