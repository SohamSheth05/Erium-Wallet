...
sealed class MarketCategory(
    ...
    object Rated : MarketCategory(
        "rated",
        R.string.Market_Category_Rated,
        R.drawable.ic_chart_24,
        R.string.Market_Category_Rated_Description
    )

    object Blockchains : MarketCategory(
        "blockchain",
        R.string.Market_Category_Blockchains,
        R.drawable.ic_blocks,
    ...
    object FiatStablecoins : MarketCategory(
        "fiat_stablecoins",
    ...
    object AlgoStablecoins : MarketCategory(
        "algo_stablecoins",
        R.string.Market_Category_AlgoStablecoins,
        R.drawable.ic_unordered_2,
        R.string.Market_Category_AlgoStablecoins_Description
    )
    ...
    object StablecoinIssuers : MarketCategory(
        "stablecoin_issuers",
        R.string.Market_Category_StablecoinIssuers,
        R.drawable.ic_app_status_24,
        R.string.Market_Category_StablecoinIssuers_Description
    )
    ...
    object B2B : MarketCategory(
        "b2b",
        R.string.Market_Category_B2B,
        R.drawable.ic_swap,
        R.string.Market_Category_B2B_Description
    )
    ...
    object Staking : MarketCategory(
        "staking_eth_2_0",
        R.string.Market_Category_Staking,
        R.drawable.ic_plus_circled,
        R.string.Market_Category_Staking_Description
    )

    object CrossChain : MarketCategory(
        "cross_chain",
        R.string.Market_Category_CrossChain,
        R.drawable.ic_link,
        R.string.Market_Category_CrossChain_Description
    )

    object Computing : MarketCategory(
        "computing",
        R.string.Market_Category_Computing,
        R.drawable.ic_dialpad_alt,
        R.string.Market_Category_Computing_Description
    )

    object RebaseTokens : MarketCategory(
        "rebase_tokens",
        R.string.Market_Category_RebaseTokens,
        R.drawable.ic_rebase,
        R.string.Market_Category_RebaseTokens_Description
    )

    object FanTokens : MarketCategory(
        "fan_tokens",
        R.string.Market_Category_FanTokens,
        R.drawable.ic_heart,
        R.string.Market_Category_FanTokens_Description
    )

    object InvestmentTools : MarketCategory(
        "investment_tools",
        R.string.Market_Category_InvestmentTools,
        R.drawable.ic_markets,
        R.string.Market_Category_InvestmentTools_Description
    )
}
