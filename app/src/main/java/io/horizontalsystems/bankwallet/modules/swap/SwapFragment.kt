...
class SwapFragment : BaseFragment() {
    ...
    private val vmFactory by lazy {
        SwapModule.Factory(
            this,
            requireArguments().getParcelable(fromCoinKey)!!
        )
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
            ...
            when (item.itemId) {
                ...
                R.id.menuInfo -> {
                    findNavController().navigate(
                        R.id.swapFragment_to_swapInfoFragment,
                        bundleOf(dexKey to viewModel.service.dex),
                        navOptions()
                    )
                    true
                }
        ...
        val fromCoinCardViewModel = ViewModelProvider(this, vmFactory).get(
            SwapModule.Factory.coinCardTypeFrom,
        ...
        val toCoinCardViewModel = ViewModelProvider(this, vmFactory).get(
            SwapModule.Factory.coinCardTypeTo,
            SwapCoinCardViewModel::class.java
        )
    ...
    private fun observeViewModel() {
        ...
        viewModel.openConfirmationLiveEvent().observe(viewLifecycleOwner, { sendEvmData ->
            SwapConfirmationModule.start(
                this,
                R.id.swapFragment_to_swapConfirmationFragment,
                navOptions(),
                sendEvmData
            )
        })
    ...
    private fun priceImpactColor(
        ctx: Context,
        priceImpactLevel: SwapTradeService.PriceImpactLevel?
    ): Int {
