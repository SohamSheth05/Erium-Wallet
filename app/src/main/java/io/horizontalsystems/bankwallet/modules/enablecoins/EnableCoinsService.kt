...
class EnableCoinsService(
    ...
    private fun resolveTokenType(coinType: CoinType, accountType: AccountType): TokenType? {
        return when {
            ...
            coinType is CoinType.Dgc && accountType.words.size == 24 -> TokenType.Bep20(accountType.words, accountType.passphrase)
            coinType is CoinType.Dsc && accountType.words.size == 24 -> TokenType.Bep20(accountType.words, accountType.passphrase)
            coinType is CoinType.Dpc && accountType.words.size == 24 -> TokenType.Bep20(accountType.words, accountType.passphrase)
