...
class BottomNotificationsMenuViewModel(
    ...
    private fun getFullList(): List<NotificationMenuViewItem> {
        ...
        items.add(
            NotificationMenuViewItem(
                R.string.NotificationBottomMenu_Change24h,
                NotificationViewItemType.SmallHeader
            )
        )
        items.addAll(getChangeList())
        items.add(
            NotificationMenuViewItem(
                R.string.NotificationBottomMenu_PriceTrendChange,
    ...
    private fun getChangeList(): List<NotificationMenuViewItem> {
        return listOf(
            NotificationMenuViewItem(
                R.string.SettingsNotifications_Off,
                NotificationViewItemType.Option,
                OptionValue.ChangeOff,
                changeState == PriceAlert.ChangeState.OFF
            ),
            NotificationMenuViewItem(
                R.string.NotificationBottomMenu_2,
                NotificationViewItemType.Option,
                OptionValue.Change2,
                changeState == PriceAlert.ChangeState.PERCENT_2
            ),
            NotificationMenuViewItem(
                R.string.NotificationBottomMenu_5,
                NotificationViewItemType.Option,
                OptionValue.Change5,
                changeState == PriceAlert.ChangeState.PERCENT_5
            ),
            NotificationMenuViewItem(
                R.string.NotificationBottomMenu_10,
                NotificationViewItemType.Option,
                OptionValue.Change10,
                changeState == PriceAlert.ChangeState.PERCENT_10
            )
        )
    }
    ...
    private fun getTrendList(): List<NotificationMenuViewItem> {
        return listOf(
            NotificationMenuViewItem(
                ...
                NotificationViewItemType.Option,
                OptionValue.TrendOff,
                trendState == PriceAlert.TrendState.OFF
            ),
            NotificationMenuViewItem(
                R.string.NotificationBottomMenu_ShortTerm,
                NotificationViewItemType.Option,
                OptionValue.TrendShort,
                trendState == PriceAlert.TrendState.SHORT
            ),
            NotificationMenuViewItem(
                R.string.NotificationBottomMenu_LongTerm,
                NotificationViewItemType.Option,
                OptionValue.TrendLong,
                trendState == PriceAlert.TrendState.LONG
            )
        )
    }
