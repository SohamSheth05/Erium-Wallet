...
class SwapSlippageViewModel(private val service: SwapTradeOptionsService) : ViewModel(),
    ...
    override val inputFieldPlaceholder =
        SwapService.defaultSlippage.stripTrailingZeros().toPlainString()
