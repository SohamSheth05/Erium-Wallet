...
class AboutFragment : BaseFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val whatsNewItem = SettingsMenuItem(
        ...
        val appStatusItem = SettingsMenuItem(
            R.string.Settings_AppStatus,
            R.drawable.ic_app_status,
            listPosition = ListPosition.First
        ) {
            findNavController().navigate(
                R.id.aboutAppFragment_to_appStatusFragment,
                null,
                navOptions()
            )
        }
        val termsItem = SettingsMenuItem(
        ...
        val githubItem = SettingsMenuItem(
        ...
        val websiteItem = SettingsMenuItem(
        ...
        val rateUsItem = SettingsMenuItem(
        ...
        val shareAppItem = SettingsMenuItem(
        ...
        val contactItem = SettingsMenuItem(
        ...
        viewModel.showWhatsNewLiveEvent.observe(viewLifecycleOwner, { gitReleaseUrl ->
            ...
            findNavController().navigate(
                R.id.aboutAppFragment_to_markdownViewer,
                arguments,
                navOptions()
            )
        })
...
class AboutAppHeaderAdapter(private val appVersion: String) :
    RecyclerView.Adapter<AboutAppHeaderAdapter.HeaderViewHolder>() {
