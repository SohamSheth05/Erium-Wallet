...
class SwapViewModel(
    ...
    fun tradeOptionsViewItemLiveData(): LiveData<TradeOptionsViewItem?> =
        tradeOptionsViewItemLiveData
    ...
    private fun tradeOptionsViewItem(tradeOptions: SwapTradeOptions): TradeOptionsViewItem {
        ...
        val slippage =
            if (tradeOptions.allowedSlippage.compareTo(defaultTradeOptions.allowedSlippagePercent) == 0) null else tradeOptions.allowedSlippage.stripTrailingZeros()
                .toPlainString()
        val deadline =
            if (tradeOptions.ttl == defaultTradeOptions.ttl) null else tradeOptions.ttl.toString()
