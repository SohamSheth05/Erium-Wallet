...
object SendModule {
    ...
    data class SendConfirmationLockTimeViewItem(val lockTimeInterval: LockTimeInterval) :
        SendConfirmationViewItem()
    ...
    class Factory(private val wallet: Wallet) : ViewModelProvider.Factory {
        ...
        override fun <T : ViewModel> create(modelClass: Class<T>): T {
            ...
            val handler: ISendHandler =
                when (val adapter = App.adapterManager.getAdapterForWallet(wallet)) {
        ...
        fun getFormattedForTxInfo(): String = when (this) {
            ...
            is CurrencyValueInfo -> {
                val significantDecimal =
                    App.numberFormatter.getSignificantDecimalFiat(currencyValue.value)
