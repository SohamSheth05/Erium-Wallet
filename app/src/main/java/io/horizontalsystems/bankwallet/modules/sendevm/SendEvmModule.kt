        ...
        override fun <T : ViewModel?> create(modelClass: Class<T>): T {
            return when (modelClass) {
                ...
                AmountInputViewModel::class.java -> {
                    ...
                    val fiatService =
                        FiatServiceSendEvm(switchService, App.currencyManager, App.xRateManager)
                ...
                SendAvailableBalanceViewModel::class.java -> {
                    val coinService =
                        EvmCoinService(wallet.coin, App.currencyManager, App.xRateManager)
                    SendAvailableBalanceViewModel(
                        service,
                        coinService,
                        listOf(service, coinService)
                    ) as T
                }
                RecipientAddressViewModel::class.java -> {
                    ...
                    val placeholder =
                        Translator.getString(R.string.SwapSettings_RecipientPlaceholder)
