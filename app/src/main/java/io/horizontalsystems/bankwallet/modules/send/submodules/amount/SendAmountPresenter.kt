...
class SendAmountPresenter(
    ...
    override fun onAmountChange(amountString: String) {
        ...
        if (amount != null && amount.scale() > decimal) {
            ...
            sendAmountInfo =
                this.amount?.let { SendAmountInfo.Entered(it) } ?: SendAmountInfo.NotEntered
    ...
    private fun syncMaxButton() {
        ...
        val hasSpendableBalance =
            noneNullAvailableBalance - minimumRequiredBalance > BigDecimal.ZERO
