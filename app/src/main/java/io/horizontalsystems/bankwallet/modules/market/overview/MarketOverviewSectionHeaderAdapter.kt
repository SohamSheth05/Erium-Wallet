...
class MarketOverviewSectionHeaderAdapter(
...
) : ListAdapter<MarketOverviewSectionHeaderAdapter.SectionHeaderItem, MarketOverviewSectionHeaderAdapter.SectionHeaderViewHolder>(
    diffCallback
) {
    ...
    companion object {
        private val diffCallback = object : DiffUtil.ItemCallback<SectionHeaderItem>() {
            override fun areItemsTheSame(
                oldItem: SectionHeaderItem,
                newItem: SectionHeaderItem
            ): Boolean {
    ...
    class SectionHeaderViewHolder(override val containerView: View) :
            ...
            fun create(parent: ViewGroup): SectionHeaderViewHolder {
                return SectionHeaderViewHolder(
                    LayoutInflater.from(parent.context)
                        .inflate(R.layout.view_holder_overview_list_section_header, parent, false)
                )
            }
        }
    }
