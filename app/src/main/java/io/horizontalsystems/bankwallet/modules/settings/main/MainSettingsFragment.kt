...
class MainSettingsFragment : BaseFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val manageKeys = SettingsMenuItem(
        ...
        val privacySettings = SettingsMenuItem(
        ...
        val walletConnect = SettingsMenuItem(
        ...
        val notifications = SettingsMenuItem(
            R.string.Settings_Notifications,
            R.drawable.ic_notification_20,
            listPosition = ListPosition.First
        ) {
            presenter.didTapNotifications()
        }
        val baseCurrency = SettingsMenuItem(
        ...
        val experimentalFeatures = SettingsMenuItem(
        ...
        val reddit = SettingsMenuItem(
            R.string.Settings_Reddit,
            R.drawable.instagram,
            listPosition = ListPosition.Last
        ) {
            presenter.didTapReddit()
        }
        val facebook = SettingsMenuItem(
            R.string.Settings_Facebook,
            R.drawable.ic_facebook,
            listPosition = ListPosition.Last
        ) {
            presenter.didTapFacebook()
        }

        val linked = SettingsMenuItem(
            R.string.Settings_Linked,
            R.drawable.ic_linkedin2,
            listPosition = ListPosition.Last
        ) {
            presenter.didTapLinked()
        }
        val aboutApp = SettingsMenuItem(
    ...
    private fun subscribeToRouterEvents(router: MainSettingsRouter) {
        ...
        router.showBaseCurrencySettingsLiveEvent.observe(viewLifecycleOwner, {
            findNavController().navigate(
                R.id.mainFragment_to_baseCurrencySettingsFragment,
                null,
                navOptions()
            )
        })
        ...
        router.showLanguageSettingsLiveEvent.observe(viewLifecycleOwner, {
            findNavController().navigate(
                R.id.mainFragment_to_languageSettingsFragment,
                null,
                navOptions()
            )
        })
        ...
        router.showThemeSwitcherLiveEvent.observe(viewLifecycleOwner, {
            findNavController().navigate(
                R.id.mainFragment_to_themeSwitchFragment,
                null,
                navOptions()
            )
        })
        ...
        router.showNotificationsLiveEvent.observe(viewLifecycleOwner, {
            findNavController().navigate(
                R.id.mainFragment_to_notificationsFragment,
                null,
                navOptions()
            )
        })
        ...
        router.showSecuritySettingsLiveEvent.observe(viewLifecycleOwner, {
            findNavController().navigate(
                R.id.mainFragment_to_securitySettingsFragment,
                null,
                navOptions()
            )
        })
        ...
        router.showExperimentalFeaturesLiveEvent.observe(viewLifecycleOwner, {
            findNavController().navigate(
                R.id.mainFragment_to_experimentalFeaturesFragment,
                null,
                navOptions()
            )
        })
        ...
        router.openWalletConnectLiveEvent.observe(viewLifecycleOwner, {
            WalletConnectListModule.start(
                this,
                R.id.mainFragment_to_walletConnectListFragment,
                navOptions()
            )
        })
    }
