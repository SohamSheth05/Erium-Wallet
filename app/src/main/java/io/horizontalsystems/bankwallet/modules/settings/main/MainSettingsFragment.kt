...
class MainSettingsFragment : BaseFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val reddit = SettingsMenuItem(R.string.Settings_Reddit, R.drawable.instagram, listPosition = ListPosition.Last) {
            presenter.didTapReddit()
        }
        val facebook = SettingsMenuItem(R.string.Settings_Facebook, R.drawable.ic_facebook, listPosition = ListPosition.Last) {
            presenter.didTapFacebook()
        }

        val linked = SettingsMenuItem(R.string.Settings_Linked, R.drawable.ic_linkedin2, listPosition = ListPosition.Last) {
