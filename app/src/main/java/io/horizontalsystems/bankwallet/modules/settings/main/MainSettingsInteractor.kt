...
class MainSettingsInteractor(
    ...
    override val companyFacebookLink: String
        get() = appConfigProvider.companyFacebookLink

    override val companyLinkedLink: String
        get() = appConfigProvider.companyLinkedLink
