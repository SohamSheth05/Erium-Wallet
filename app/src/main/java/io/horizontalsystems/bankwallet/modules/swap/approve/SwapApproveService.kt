...
class SwapApproveService(
    ...
    private val stateSubject =
        BehaviorSubject.createDefault<State>(State.ApproveNotAllowed(listOf()))
    ...
    private fun syncState() {
        ...
        state = if (errors.isEmpty()) {
            val erc20KitTransactionData =
                erc20Kit.buildApproveTransactionData(spenderAddress, amount)
