...
class MainFragment : BaseFragment(), RateAppDialogFragment.Listener {
    ...
    override fun onCreateView(
        ...
        view.viewPager.adapter =
            MainViewPagerAdapter(childFragmentManager, viewLifecycleOwner.lifecycle)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.showWhatsNewLiveEvent.observe(viewLifecycleOwner, { gitReleaseUrl ->
            val arguments = bundleOf(
                MarkdownFragment.gitReleaseNotesUrlKey to gitReleaseUrl,
                MarkdownFragment.showAsClosablePopupKey to true
            )
            findNavController().navigate(
                R.id.mainFragment_to_markdownViewer,
                arguments,
