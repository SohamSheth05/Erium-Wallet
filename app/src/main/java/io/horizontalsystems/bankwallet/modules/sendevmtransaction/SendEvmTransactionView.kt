...
class SendEvmTransactionAdapter : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        when (val item = items[position].viewItem) {
            ...
            is ViewItem.Value -> (holder as? TitleValueViewHolder)?.bind(
                item.title,
                item.value,
                item.type,
                listPosition
    ...
    class SpaceViewHolder(override val containerView: View) :
        ...
        companion object {
            fun create(parent: ViewGroup) =
                SpaceViewHolder(inflate(parent, R.layout.view_send_evm_space, false))
        }
    }

    class SubheadViewHolder(override val containerView: View) :
        RecyclerView.ViewHolder(containerView), LayoutContainer {
        ...
        companion object {
            fun create(parent: ViewGroup) = SubheadViewHolder(
                inflate(
                    parent,
                    R.layout.view_holder_evm_confirmation_subhead,
                    false
                )
            )
        }
    ...
    class TitleValueHexViewHolder(override val containerView: View) :
        RecyclerView.ViewHolder(containerView), LayoutContainer {
        ...
        companion object {
            fun create(parent: ViewGroup) = TitleValueHexViewHolder(
                inflate(
                    parent,
                    R.layout.view_holder_title_value_hex,
                    false
                )
            )
        }
    ...
    class TitleValueViewHolder(override val containerView: View) :
        ...
        companion object {
            fun create(parent: ViewGroup) =
                TitleValueViewHolder(inflate(parent, R.layout.view_holder_title_value, false))
        }
    }
}
