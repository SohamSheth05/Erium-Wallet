...
class MarketOverviewFragment : BaseFragment(), ViewHolderMarketOverviewItem.Listener,
    ViewHolderMarketPostItem.Listener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val topLoadingAdapter = MarketLoadingAdapter(
        ...
        val topGainersHeaderAdapter = MarketOverviewSectionHeaderAdapter(
            ...
            settingsHeaderItem = MarketOverviewSectionHeaderAdapter.SectionHeaderItem(
                R.string.RateList_TopGainers,
                R.drawable.ic_circle_up_20,
                getString(R.string.Market_SeeAll)
            ) {
        ...
        val topLosersHeaderAdapter = MarketOverviewSectionHeaderAdapter(
            ...
            viewLifecycleOwner = viewLifecycleOwner,
            settingsHeaderItem = MarketOverviewSectionHeaderAdapter.SectionHeaderItem(
                R.string.RateList_TopLosers,
                R.drawable.ic_circle_down_20,
                getString(R.string.Market_SeeAll)
            ) {
        ...
        val postsHeaderAdapter = MarketOverviewSectionHeaderAdapter(
            ...
            viewLifecycleOwner = viewLifecycleOwner,
            settingsHeaderItem = MarketOverviewSectionHeaderAdapter.SectionHeaderItem(
                R.string.RateList_Posts,
                R.drawable.ic_post_20
            )
        )
        ...
        val poweredByAdapter =
            PoweredByAdapter(marketOverviewViewModel.showPoweredByLiveData, viewLifecycleOwner)
