...
class MarketDiscoveryService(
    ...
    val marketCategories = listOf(
        ...
        MarketCategory.Staking,
        MarketCategory.CrossChain,
        MarketCategory.Computing
    )
    ...
    private fun getMarketItemsByCategoryAsync(
