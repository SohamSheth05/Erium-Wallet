...
) : ViewModel(), IRecipientAddressService, SendAddressModule.IAddressModule,
    SendAddressModule.IInteractorDelegate, SendAddressModule.IViewDelegate {

    private val errorsObservable =
        BehaviorSubject.createDefault<Optional<Throwable>>(Optional.empty())
