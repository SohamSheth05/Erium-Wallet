...
class MarketDiscoveryFragment : BaseFragment(), MarketListHeaderView.Listener,
    ViewHolderMarketItem.Listener, MarketCategoriesAdapter.Listener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val marketCategoriesAdapter = MarketCategoriesAdapter(
            requireContext(),
            tabLayout,
            marketDiscoveryViewModel.marketCategories,
            this
        )
