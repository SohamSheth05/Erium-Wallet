...
class BottomNotificationMenu(
    ...
    private val viewModel by viewModels<BottomNotificationsMenuViewModel> {
        NotificationBottomMenuModule.Factory(
            coinType,
            coinName,
            mode
        )
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        setHeaderIconDrawable(context?.let {
...
class NotificationMenuItemsAdapter(private val listener: Listener) :
