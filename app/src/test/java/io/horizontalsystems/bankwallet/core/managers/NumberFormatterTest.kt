...
class NumberFormatterTest {
    ...
    private fun assertFormattedCoin(
        value: BigDecimal,
        ...
        val formatted =
            numberFormatter.formatCoin(value, "BTC", minimumFractionDigits, maximumFractionDigits)
    ...
    private fun assertFormattedCoinSignificant(value: BigDecimal, expected: String) {
        val formatted = numberFormatter.formatCoin(
            value,
            "BTC",
            0,
            numberFormatter.getSignificantDecimalCoin(value)
        )
    ...
    private fun assertFormattedFiat(
        value: BigDecimal,
        minimumFractionDigits: Int,
        maximumFractionDigits: Int,
        expected: String
        ...
        val formatted =
            numberFormatter.formatFiat(value, "$", minimumFractionDigits, maximumFractionDigits)
    ...
    private fun assertFormattedFiatSignificant(value: BigDecimal, expected: String) {
        val formatted = numberFormatter.formatFiat(
            value,
            "$",
            0,
            numberFormatter.getSignificantDecimalFiat(value)
        )
