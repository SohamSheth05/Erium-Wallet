...
import io.horizontalsystems.xrateskit2.core.ICoinMarketManager
...
class CoinMarketsManager(
    ...
    override fun getCoinMarketDetailsAsync(
        ...
        return Single.zip(
            coinGeckoProvider.getCoinMarketDetailsAsync(
                coinType,
                currencyCode,
                rateDiffCoinCodes,
                rateDiffPeriods
            ...
            defiMarketsProvider.getDefiTvlAsync(coinType, currencyCode).onErrorReturnItem(
                DefiTvl(
                    CoinData(coinType, "", ""),
                    BigDecimal.ZERO,
                    BigDecimal.ZERO
