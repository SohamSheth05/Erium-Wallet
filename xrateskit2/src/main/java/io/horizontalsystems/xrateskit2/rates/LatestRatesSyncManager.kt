...
import io.horizontalsystems.xrateskit2.entities.LatestRateKey
import io.horizontalsystems.xrateskit2.entities.PairKey
...
class LatestRatesSyncManager(
    ...
    private val subjects =
        ConcurrentHashMap<LatestRateKey, PublishSubject<Map<CoinType, LatestRate>>>()
