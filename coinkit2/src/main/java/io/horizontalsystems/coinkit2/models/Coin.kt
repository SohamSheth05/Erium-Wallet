package io.horizontalsystems.coinkit2.models
...
sealed class CoinType : Parcelable {
    ...
    val address1: String = "0x2c8aec2fd0c0feba71e0424873461908067d5bf4"
    val address2: String = "0xc05873c48a06982b82bb44bfdb60c196e832dee5"
    val address3: String = "0xb67e5fb0473320ae40b2adf0120a15968ebb0a85"
    val ID: String
        get() = getCoinId()
    ...
    fun getCoinId(): String {
        return when (this) {
            is Dgc -> "erc20|0x2c8aec2fd0c0feba71e0424873461908067d5bf4"
            is Dsc -> "bep20|0xc05873c48a06982b82bb44bfdb60c196e832dee5"
            is Dpc -> "bep20|0xb67e5fb0473320ae40b2adf0120a15968ebb0a85"
            is Bitcoin -> "bitcoin"
                ...
                if (category.asObject().get("address") != null) {
                    if (!category.asObject().get("address").isNull) {
                        typeString = "${typeString.trim()}|${
                            category.asObject().get("address").asString().trim()
                        }"
                    ...
                    if (!category.asObject().get("symbol").isNull)
                        typeString = "${typeString.trim()}|${
                            category.asObject().get("symbol").asString().trim()
                        }"
                }
